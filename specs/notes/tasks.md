...
- [x] 6. `features/create-note`: **+ New Note** creates and opens the editor.
     _Covers: 1.1_ · _Figma: board button_ · _Tests: `CreateNoteButton.test.tsx`_
- [x] 7. `features/edit-note`: editor (title/content/category/close), debounced
     ...
     _Covers: 1.3, 2.1–2.4, 3.1–3.3, 4.1_ · _Figma: frames 2:8568 (editor) / 2:39
     (card)_ · _Tests: `NoteEditor.test.tsx`_

## Verification

- [x] 8. Traceability: every criterion (1.1–4.1) has ≥1 test naming its ID.
